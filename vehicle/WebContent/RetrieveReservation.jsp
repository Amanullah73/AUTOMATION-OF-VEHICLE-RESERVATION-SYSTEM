...
<tr>
<td align="center"><marquee behavior="alternate">
VECHILE RESERVATION INFORMATION RETRIVAL
</td></marquee>
</tr>
</table>
...
<TABLE width="100%" cellpadding="15" border="6" bordercolor="red" align="center">
<%
while (rs.next()) {
%>
<TR>
