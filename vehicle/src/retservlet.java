...
public void doGet(HttpServletRequest req,HttpServletResponse res)throws ServletException
{
	...
	if(text1=="")
		pw.println("plz provide retailerId");
	else if(text2=="")
		...
		pw.println("plz provide timing");
	else if(text6=="")
		pw.println("plz provide customername");
	else if(text6=="")
	...
	else
	{
		 DBConnect db= new DBConnect();		
			int a=db.insertData6(text1,text2,text3,text4,text5,text6,text7);
			                           		 
				if(a>0){
				 pw.println("retailer data is submitted");
				  pw.println("<html>");
